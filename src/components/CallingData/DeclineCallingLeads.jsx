            ...
            <tr key={index} className="hover:bg-gray-50">
              <td className="px-4 py-2 text-sm text-gray-600 bg-gray-100">
                {CallDetail.updatedDate?.[index] ? (
                  <DateFormatter timestamp={CallDetail.updatedDate[index]} />
                ) : (
                  "----"
                )}
              </td>
              <td className="px-4 py-2 text-sm text-gray-600 bg-gray-100">
                {CallDetail.nextCallDate?.[index] ? (
                  <DateFormatter timestamp={CallDetail.nextCallDate[index]} />
                ) : (
                  "----"
                )}
              </td>
...
export default function DeclineCallingLeads() {
  ...
  return (
    <>
      ...
      <div className="p-1.8 border-b bg-gray-100 dark:bg-gray-800 rounded-md">
        <TableNavbar
          Leadheading={"Decline Calling Leads"}
                      ...
                      <td className="px-4 py-2 text-sm whitespace-nowrap relative">
                        ...
                        >
                          <div className="flex items-center bg-gray-200 px-2 py-1 rounded-md">
                            <span className="text-gray-600 font-xs">
                              <DateFormatter
                                timestamp={leadReport.nextCallDate?.[0] || null}
                                date={true}
                              />
                            </span>
                          </div>
                        ...
                        {/* {callDeatil === index && (
                          <div className="absolute top-full left-0 mb-7 z-10">
                            <CallDetails
