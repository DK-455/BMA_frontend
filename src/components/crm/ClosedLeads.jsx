...
import Fibform from "./fib/Fibform";
import Showmore from "./fib/showmore";
                ...
                rows.map((leadReport, index) => (
                  <React.Fragment key={index}>
                    <tr className="hover:bg-gray-50">
                        ...
                        <div className="text-sm">
                          ...
                          leadReport.leads.projectName.length > 1 ? (
                            <div  className="cursor-pointer text-gray-700 hover:text-blue-600 hover:underline dark:text-gray-300">
                              <span
                                                            onClick={() => handleShareProject(leadReport.leads.id , duplicate)}>
                            ...
                            <span
                            onClick={() =>
                              handleShareProject(leadReport.leads.id , duplicate) // Include type
                            }
                      ...
                      <td className="px-4 py-2 text-gray-600 whitespace-nowrap text-center">
                        <DateFormatter timestamp={leadReport.closureDate} />
                      </td>
                      ...
                      <td className="px-4 py-2 text-gray-600 whitespace-nowrap text-center relative">
                        {leadReport.fibId ? (
                          ...
                          <span
                            ...
                            onClick={() =>
                              handleShowAddFib(leadReport.leads.id)
                            }
                          >
                            Add now
                          </span>
                      ...
                      {modalState.isOpen &&
                        ...
                        modalState.id === leadReport.leads.id && (
                          <Fibform
                            leadId={leadReport.leads.id}
                            onClose={handleCloseModal}
                            refreshData={refreshData}
